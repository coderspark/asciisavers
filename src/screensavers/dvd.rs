...
pub fn dvd(cornercounter: bool, delay: u64) {
    ...
    pos = (
        rand::thread_rng().gen_range(2..tsize.0 - 17) as i32,
        rand::thread_rng().gen_range(2..tsize.1 - 6) as i32,
    );
    ...
    let colours = [
        "\x1b[38;2;255;61;61m",
        "\x1b[38;2;255;200;61m",
        "\x1b[38;2;255;255;61m",
        "\x1b[38;2;61;255;61m",
        "\x1b[38;2;61;255;255m",
        "\x1b[38;2;61;61;255m",
        "\x1b[38;2;255;61;255m",
    ];
    let mut colouridx = 0;
